...
<div class="md:flex md:items-start md:gap-8">
  ...
  <figure class="hidden md:flex md:items-center md:justify-center w-full md:w-1/2 flex-shrink-0 self-center">
    ...
    <div class="light:block dark:hidden">
       <img src="/images/projects/haepapacom.png" alt="Haepapa website idea" class="rounded-lg h-[250px] mx-auto object-contain" loading="lazy"  />
     </div>
     <div class="hidden dark:block">
       <img src="/images/projects/haepapacom_dark.png" alt="Haepapa website idea" class="rounded-lg h-[250px] mx-auto object-contain" loading="lazy"  />
     </div>
...
<div class="md:flex md:items-start md:gap-8">
  <figure class="hidden md:flex md:items-center md:justify-center w-full md:w-1/2 flex-shrink-0 self-center">
    ...
    <div class="light:block dark:hidden">
       <img src="/images/projects/haepapacom_Inspiration.png" alt="Haepapa website inspiration" class="rounded-lg h-[250px] mx-auto object-contain" loading="lazy"  />
     </div>
     <div class="hidden dark:block">
       <img src="/images/projects/haepapacom_Inspiration_dark.png" alt="Haepapa website inspiration" class="rounded-lg h-[250px] mx-auto object-contain" loading="lazy"  />
     </div>
